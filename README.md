...
| `action` | Panel-local action instead of sending text: `watch-toggle` (the grid watcher) or `mark-toggle` (the per-pane mark). Action buttons never type into the chat. |
